/**
 * @deprecated DEAD CODE — Bug 1 fix
 * All scoring logic now runs exclusively in the Python backend (ergo_ml_backend/).
 * The functions in this file are never called after the backend integration.
 * Do NOT use these for any calculations — they use different weights to the backend
 * and will produce inconsistent results.
 * Kept here only to avoid breaking the TypeScript compilation if referenced elsewhere.
 */
